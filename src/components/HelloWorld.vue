<template>
  <div class="hello h1" @click="count">
    <h1>{{ msg }}</h1>
    <p>
      {{ add }}
    ...
    <h3 class="h3">Installed CLI Plugins</h3>
    <ul>
      <li>
      ...
      <li>
        <a href="https://github.com/vuejs/vue-cli/tree/dev/packages/%40vue/cli-plugin-unit-mocha" target="_blank" rel="noopener">unit-mocha</a>
      </li>
      <li>
